  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit} className="grid gap-4">
        ...
        <div className="grid gap-1.5">
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-2.5 top-1/2 -translate-y-1/2 rounded-md p-1 text-ink-soft hover:bg-mist hover:text-ink"
            >
              {showPassword ? (
        ...
        <div className="grid gap-1 text-center text-[12.5px] text-ink-soft">
          <p>
            New to BATRIS?{" "}
            <Link
          ...
          <button
            ...
            className="cursor-pointer justify-self-center font-medium text-ink-soft underline decoration-line underline-offset-4 hover:text-ink"
          >
