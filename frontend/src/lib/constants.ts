// /**
//  * Project-wide constants for the frontend.
//  *
//  * The first block is a direct mirror of `backend/batris/constants.py`. Anything
//  * added to the Python file should be added here too, and vice versa — the two
//  * are kept deliberately identical rather than fetched at runtime so that the
//  * marketing pages can render without the API being up.
//  */

// // ---------------------------------------------------------------------------
// // Mirrored from backend/batris/constants.py
// // ---------------------------------------------------------------------------
...
// export const METHOD_TAG_MEASURED = "Method: reference measurement";
...
//       { href: "/#limits", label: "Where it stops working" },
...
//     body: "An Ed25519-signed JSON document carrying the assessment, the model provenance and the method labels. Alter one field and verification fails.",
//     tag: "Verifiable",
//   },
// ] as const;
